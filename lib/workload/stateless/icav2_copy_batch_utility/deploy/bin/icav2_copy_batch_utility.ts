...
import {
  ...
  ICAV2_COPY_SINGLE_STATE_MACHINE_ARN_SSM_PARAMETER_PATH,
} from '../constants';
...
new ICAv2CopyBatchUtilityStack(app, 'Icav2CopyBatchUtilityStack', {
    ...
    icav2_copy_single_state_machine_ssm_parameter_path: ICAV2_COPY_SINGLE_STATE_MACHINE_ARN_SSM_PARAMETER_PATH,
    env: {
