...
import {
    cttsov2ManagerReadyEventHandlerConstruct
} from "./constructs/part_3/cttsov2-ready-event-handler";
    ...
    constructor(scope: Construct, id: string, props: cttsov2GlueHandlerConstructProps) {
       ...
       */
        ...
        */
        ...
        const ctTSOv2InputMaker = new cttsov2InputMakerConstruct(
            this,
            'cttso_v2_input_maker',
            {
