...
export class fastqListRowsToCttsov2InputMakerConstruct extends Construct {
    public declare fastqListRowsTocttsov2InputMakerEventMap: {
    ...
    constructor(scope: Construct, id: string, props: fastqListRowsToCttsov2InputMakerConstructProps) {
        ...
        */
        ...
        const get_library_ids_lambda_obj = new PythonFunction(
            this,
            'get_library_ids_event_lambda',
            {
        ...
        const samplesheet_slim_lambda_obj = new PythonFunction(
            this,
            'samplesheet_slim_lambda',
            {
        ...
        const fastq_list_row_slim_lambda_obj = new PythonFunction(
            this,
            'fastq_list_row_slim_lambda',
            {
                entry: path.join(__dirname, 'lambdas', 'slim_fastq_list_row_py'),
                index: 'slim_fastq_list_row.py',
                handler: 'handler',
                runtime: Runtime.PYTHON_3_11,
                architecture: Architecture.ARM_64
            }
        ...
        */
        const inputMakerScatterSfn = new sfn.StateMachine(this, 'cttsov2_inputs_generator', {
            ...
            definitionSubstitutions: {
                ...
                __samplesheet_partition_name__: this.fastqListRowsTocttsov2InputMakerEventMap.samplesheetTablePartitionName,
                __fastq_list_row_partition_name__: this.fastqListRowsTocttsov2InputMakerEventMap.fastqListRowTablePartitionName,
                __translate_event_lambda_function_arn__: libraryrunstatechange_lambda_obj.currentVersion.functionArn,
                __get_library_set_lambda_function_arn__: get_library_ids_lambda_obj.currentVersion.functionArn,
                __slim_samplesheet_lambda_function_arn__: samplesheet_slim_lambda_obj.currentVersion.functionArn,
                __slim_fastq_list_row_lambda_function_arn__: fastq_list_row_slim_lambda_obj.currentVersion.functionArn,
        ...
        */
        const eventRule = new events.Rule(this, 'scatter_cttsov2_input_maker_jobs_on_new_fastq_list_rows', {
