    ...
    */
    const eventRule = new events.Rule(this, 'update_database_on_new_samplesheet_event_rule', {
      ...
      eventPattern: {
        ...
        detail: {
          status: [
            { 'equals-ignore-case': this.updateDataBaseOnNewSamplesheetEventMap.triggerStatus },
          ],
          workflowName: [
            {
              'equals-ignore-case': this.updateDataBaseOnNewSamplesheetEventMap.triggerWorkflowName,
            },
          ],
        },
      },
