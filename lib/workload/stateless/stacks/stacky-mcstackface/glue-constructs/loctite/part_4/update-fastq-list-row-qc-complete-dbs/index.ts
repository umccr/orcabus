...
export interface TnFastqListRowQcCompleteDbRowConstructProps {
  tableObj: dynamodb.ITableV2;
  eventBusObj: events.IEventBus;
}

export class TnFastqListRowQcCompleteConstruct extends Construct {
  public readonly TnFastqListRowQcCompleteDbRowMap = {
  ...
  constructor(scope: Construct, id: string, props: TnFastqListRowQcCompleteDbRowConstructProps) {
    super(scope, id);
    ...
    */
    const inputMakerSfn = new sfn.StateMachine(this, 'fastq_list_row_qc_complete', {
      stateMachineName: `${this.TnFastqListRowQcCompleteDbRowMap.prefix}-sfn`,
      ...
      definitionSubstitutions: {
        ...
        __fastq_list_row_partition_name__: this.TnFastqListRowQcCompleteDbRowMap.tablePartition,
      },
    });
    ...
    */
    const rule = new events.Rule(this, 'tn_populate_fastq_list_row', {
      ruleName: `stacky-${this.TnFastqListRowQcCompleteDbRowMap.prefix}-event-rule`,
      eventBus: props.eventBusObj,
      eventPattern: {
        source: [this.TnFastqListRowQcCompleteDbRowMap.triggerSource],
        detailType: [this.TnFastqListRowQcCompleteDbRowMap.triggerDetailType],
        detail: {
          status: [{ 'equals-ignore-case': this.TnFastqListRowQcCompleteDbRowMap.triggerStatus }],
        },
      },
    });
