...
ROOT_URLCONF = "fastq_manager.urls.base"
...
WSGI_APPLICATION = "fastq_manager.wsgi.application"
...
XRAY_RECORDER = {
    ...
    "AWS_XRAY_TRACING_NAME": os.getenv("AWS_XRAY_TRACING_NAME", "fastq_manager"),
}
