...
Usage:
- export DJANGO_SETTINGS_MODULE=fastq_manager.settings.local
"""
import sys
...
ROOT_URLCONF = "fastq_manager.urls.local"
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'UMCCR OrcaBus fastq_manager API',
    'DESCRIPTION': 'UMCCR OrcaBus fastq_manager API',
    'VERSION': API_VERSION,
