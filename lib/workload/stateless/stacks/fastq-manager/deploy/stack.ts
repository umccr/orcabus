...
} from '../../../../../../lib/workload/components/api-gateway';

export interface FastqManagerStackProps {
...
export class FastqManagerStack extends Stack {
  ...
  private props: FastqManagerStackProps;
  ...
  constructor(scope: Construct, id: string, props: StackProps & FastqManagerStackProps) {
    ...
    this.lambdaEnv = {
      DJANGO_SETTINGS_MODULE: 'fastq_manager.settings.aws',
  ...
  private createApiHandlerAndIntegration(props: FastqManagerStackProps) {
