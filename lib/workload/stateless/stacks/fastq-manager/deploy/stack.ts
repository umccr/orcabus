...
export class FastqManagerStack extends Stack {
  ...
  private build_ntsm_count_sfn(props: BuildSfnWithEcsProps): IStateMachine {
    ...
    const taskDefinition = this.build_ecs_task_definition(2, 4, 'ntsm-task');
  ...
  private build_api_lambda_function(props: LambdaApiFunctionProps) {
    const lambdaApiFunction = new PythonUvFunction(this, 'FastqManagerApi', {
      ...
      environment: {
        ...
        /* Event detail types */
        EVENT_DETAIL_TYPE_CREATE_FASTQ_LIST_ROW: props.eventDetailType.createFastqListRow,
        EVENT_DETAIL_TYPE_UPDATE_FASTQ_LIST_ROW: props.eventDetailType.updateFastqListRow,
        EVENT_DETAIL_TYPE_DELETE_FASTQ_LIST_ROW: props.eventDetailType.deleteFastqListRow,
        EVENT_DETAIL_TYPE_CREATE_FASTQ_SET: props.eventDetailType.createFastqSet,
        EVENT_DETAIL_TYPE_UPDATE_FASTQ_SET: props.eventDetailType.updateFastqSet,
        EVENT_DETAIL_TYPE_MERGE_FASTQ_SET: props.eventDetailType.mergeFastqSet,
        EVENT_DETAIL_TYPE_DELETE_FASTQ_SET: props.eventDetailType.deleteFastqSet,
        /* SFN env vars */
