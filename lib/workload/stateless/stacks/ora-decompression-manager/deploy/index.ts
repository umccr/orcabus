...
export interface OraDecompressionManagerConfig {
  /* Stack essentials */
  eventBusName: string;
  detailType: string;
  source: string;
...
export type OraDecompressionManagerStackProps = OraDecompressionManagerConfig & cdk.StackProps;
