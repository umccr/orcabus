...
export type UmccriseIcav2PipelineManagerStackProps = UmccriseIcav2PipelineManagerConfig &
  cdk.StackProps;

export class UmccriseIcav2PipelineManagerStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: UmccriseIcav2PipelineManagerStackProps) {
    ...
    */
    ...
    const configureInputsSfn = new sfn.StateMachine(
      this,
      'umccrise_v2_launch_step_functions_state_machine',
      {
        ...
        definitionBody: DefinitionBody.fromFile(
          path.join(
            ...
            'set_umccrise_cwl_inputs_sfn.asl.json'
          )
        ),
    ...
    */
    ...
    const configureOutputsSfn = new sfn.StateMachine(this, 'sfn_configure_outputs_json', {
      ...
      // defintiontemplate
      definitionBody: DefinitionBody.fromFile(
        path.join(__dirname, '../step_functions_templates', 'set_umccrise_cwl_outputs_sfn.asl.json')
      ),
      // definitionSubstitutions
      definitionSubstitutions: {
        /* Dynamodb tables */
    ...
    new WfmWorkflowStateChangeIcav2ReadyEventHandlerConstruct(this, 'umccrise_wfm_sfn_handler', {
