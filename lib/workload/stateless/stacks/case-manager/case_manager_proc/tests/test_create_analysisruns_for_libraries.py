...
from case_manager.models import AnalysisContext, Analysis, Library
from case_manager.models.analysis import AnalysisName
from case_manager.models.analysis_context import Usecase, ComputeOption, StorageOption, ApprovalOption
from case_manager_proc.services.create_analysisruns_for_libraries import get_analysis_context, get_analysis
from case_manager_proc.tests.case import CaseManagerProcUnitTestCase, logger
from case_manager_proc.services import create_analysisruns_for_libraries as car


class CaseSrvUnitTests(CaseManagerProcUnitTestCase):
    mock_wgs_lib_n = {}
    mock_wgs_lib_t = {}
    mock_wts_lib = {}
    mock_cttso_lib = {}
    ...
    def test_get_analysis_context_exist(self):
        """
        python manage.py test case_manager_proc.tests.test_create_analysisruns_for_libraries.CaseSrvUnitTests.test_get_analysis_context_exist
        """
    ...
    def test_get_analysis_context_not_exist(self):
        """
        python manage.py test case_manager_proc.tests.test_create_analysisruns_for_libraries.CaseSrvUnitTests.test_get_analysis_context_not_exist
        """
    ...
    def test_get_analysis(self):
        """
        python manage.py test case_manager_proc.tests.test_create_analysisruns_for_libraries.CaseSrvUnitTests.test_get_analysis
        """
    ...
    def test_create_qc_analysis(self):
        """
        python manage.py test case_manager_proc.tests.test_create_analysisruns_for_libraries.CaseSrvUnitTests.test_create_qc_analysis
        """
    ...
    def test_create_cttso_analysis(self):
        """
        python manage.py test case_manager_proc.tests.test_create_analysisruns_for_libraries.CaseSrvUnitTests.test_create_cttso_analysis
        """
        # setup fixtures
        nata_context = get_analysis_context(usecase=Usecase.APPROVAL.value, name=ApprovalOption.NATA.value)
        ...
        # Test: v1 chemistry + clinical case
        ...
        # Test: v2 chemistry + research case
        # expect: v2 analysis + research envs
        cttso_lib_new = copy.deepcopy(self.mock_cttso_lib)
        cttso_lib_new['case'] = 'research'
        ...
        # Test: v2 chemistry + clinical case
        # expect: v2 analysis + accredited envs
        cttso_lib_new = copy.deepcopy(self.mock_cttso_lib)
        cttso_lib_new['assay'] = 'ctTSOv2'
        cttso_lib_new['case'] = 'clinical'
        mock_libs = [
            self.mock_wgs_lib_n,
            cttso_lib_new
        ]
    ...
    def test_create_wgs_analysis(self):
        """
        python manage.py test case_manager_proc.tests.test_create_analysisruns_for_libraries.CaseSrvUnitTests.test_create_wgs_analysis
        """
        # setup fixtures
        clinical_context = get_analysis_context(usecase=Usecase.APPROVAL.value, name=ApprovalOption.CLINICAL.value)
        accr_compute_context = get_analysis_context(usecase=Usecase.COMPUTE.value, name=ComputeOption.ACCREDITED.value)
        ...
        # Test: given a tumor and normal WGS pair + clinical case
