...
from case_manager_proc.services import create_case_run_state
from case_manager_proc.tests.case import CaseManagerProcUnitTestCase, logger
from case_manager.models import CaseRun, State, CaseRunUtil, Library
from case_manager.tests.factories import CaseRunFactory
...
class CaseSrvUnitTests(CaseManagerProcUnitTestCase):
    ...
    def test_create_wrsc_no_library(self):
        """
        python manage.py test case_manager_proc.tests.test_create_case_run_state.CaseSrvUnitTests.test_create_wrsc_no_library
        """
        ...
        test_event = {
            ...
            "payload": {
                ...
                "data": {
                    ...
                    "pipelineDescription": "This is an ctTSO500 case execution",
        ...
        result_wrsc: CaseRunStateChange = create_case_run_state.handler(test_event, None)
        logger.info(result_wrsc)
        self.assertIsNotNone(result_wrsc)
        self.assertEqual("ctTSO500-L000002", result_wrsc.caseRunName)
        ...
        wfr_qs: QuerySet = CaseRun.objects.all()
        self.assertEqual(1, wfr_qs.count())
        db_wfr: CaseRun = wfr_qs.first()
        self.assertEqual("ctTSO500-L000002", db_wfr.case_run_name)
        # We don't expect any library associations here!
    ...
    def test_create_wrsc_no_payload(self):
        """
        python manage.py test case_manager_proc.tests.test_create_case_run_state.CaseSrvUnitTests.test_create_wrsc_no_payload
        """
    ...
    def test_create_wrsc_library(self):
        """
        python manage.py test case_manager_proc.tests.test_create_case_run_state.CaseSrvUnitTests.test_create_wrsc_library
        """
    ...
    def test_create_wrsc_library_exists(self):
        """
        python manage.py test case_manager_proc.tests.test_create_case_run_state.CaseSrvUnitTests.test_create_wrsc_library_exists
        """
    ...
    def test_get_last_state(self):
        """
        python manage.py test case_manager_proc.tests.test_create_case_run_state.CaseSrvUnitTests.test_get_last_state
        """

        wfr: CaseRun = CaseRunFactory()
        s1: State = State(
        ...
        latest: State = CaseRunUtil.get_latest_state(states)
        ...
        # Now test from CaseRun level (need to persist DB objects though)
        s1.save()
        s2.save()
        s3.save()
        s4.save()
        wfr.save()
        util = CaseRunUtil(wfr)
