...
class CaseRunStateChange(object):
    ...
    def __init__(self, portalRunId=None, timestamp=None, status=None, caseName=None, caseVersion=None, caseRunName=None, linkedLibraries=None, payload=None):  # noqa: E501
