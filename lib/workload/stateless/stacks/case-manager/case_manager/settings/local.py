...
Usage:
- export DJANGO_SETTINGS_MODULE=case_manager.settings.local
"""
import sys
...
ROOT_URLCONF = "case_manager.urls.local"
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'UMCCR OrcaBus case_manager API',
    'DESCRIPTION': 'UMCCR OrcaBus case_manager API',
    'VERSION': API_VERSION,
