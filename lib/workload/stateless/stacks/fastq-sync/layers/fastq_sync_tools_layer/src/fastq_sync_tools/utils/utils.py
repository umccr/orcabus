...
def check_fastq_list_row_against_requirements_list(
    ...
    for requirement in requirements:
        # Check read set
        if requirement == Requirements.HAS_ACTIVE_READ_SET:
        ...
        # Check qc
        if requirement == Requirements.HAS_QC:
        ...
        # Check fingerprint
        if requirement == Requirements.HAS_FINGERPRINT:
        ...
        if requirement == Requirements.HAS_FILE_COMPRESSION_INFORMATION:
