...
router.register(r"sequence/(?P<orcabus_id>[^/.]+)/state", StateViewSet, basename="sequence-state")
router.register(r"sequence/(?P<orcabus_id>[^/.]+)/comment", CommentViewSet, basename="sequence-comment")
urlpatterns = [
