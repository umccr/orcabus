# Generated by Django 5.1 on 2024-09-20 04:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('sample', models.ForeignKey(blank=True, db_column='sample_orcabus_id', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='sample_orcabus_id', to='app.sample')),
                ('subject', models.ForeignKey(blank=True, db_column='subject_orcabus_id', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', related_query_name='subject_orcabus_id', to='app.subject')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='library',
            name='sample',
            field=models.ForeignKey(blank=True, db_column='sample_orcabus_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='sample_orcabus_id', to='app.sample'),
        ),
        migrations.AddField(
            model_name='library',
            name='subject',
            field=models.ForeignKey(blank=True, db_column='subject_orcabus_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='subject_orcabus_id', to='app.subject'),
        ),
        migrations.CreateModel(
