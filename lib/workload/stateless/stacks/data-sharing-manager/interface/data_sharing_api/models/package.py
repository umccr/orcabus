...
# Util imports
from ..utils import (
    to_camel, get_ulid, get_packaging_endpoint_url, get_s3_sharing_prefix, to_snake
)
...
class PackageWithId(PackageBase, PackageOrcabusId):
    ...
    package_s3_sharing_prefix: str = Field(default_factory=lambda data: get_s3_sharing_prefix(data['id']))
