...
def handler(events, context):
    ...
    return {
        "alignment_output_uri": convert_project_data_obj_to_uri(alignment_data_obj, uri_type=UriType.S3),
        "bam_file_uri": convert_project_data_obj_to_uri(bam_file_obj, uri_type=UriType.S3) if bam_file_obj else None,
        "multiqc_html_report": convert_project_data_obj_to_uri(multiqc_html_data_obj, uri_type=UriType.S3),
        "multiqc_output_uri": convert_project_data_obj_to_uri(multiqc_data_obj, uri_type=UriType.S3)
    }
