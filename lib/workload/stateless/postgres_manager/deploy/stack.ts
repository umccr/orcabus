...
export type PostgresManagerStackConfig = {
...
export type PostgresManagerStackProps = PostgresManagerStackConfig & {
  vpc: ec2.IVpc;
  lambdaSecurityGroup: ec2.ISecurityGroup;
};

export class PostgresManagerStack extends Construct {
  constructor(scope: Construct, id: string, props: PostgresManagerStackProps) {
    ...
    const alterDbPgOwnerLambda = new nodejs.NodejsFunction(this, 'AlterDbOwnerPassPostgresLambda', {
      ...rdsLambdaProps,
