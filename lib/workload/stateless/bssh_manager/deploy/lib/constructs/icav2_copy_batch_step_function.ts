...
export interface ICAv2CopyBatchStateMachineConstructProps {
...
export class ICAv2CopyBatchStateMachineConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: ICAv2CopyBatchStateMachineConstructProps) {
    super(scope, id);
    ...
    const manifest_inverter_lambda = new lambda.Function(this, 'manifest_inverter_lambda', {
      ...
      code: lambda.Code.fromAsset(props.manifest_handler_lambda_path),
