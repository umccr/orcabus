...
import { ICAv2CopyBatchStateMachineConstruct } from '../constructs/icav2_copy_batch_step_function';

// import * as sqs from 'aws-cdk-lib/aws-sqs';
interface ICAv2CopyBatchStateMachineStackProps extends cdk.StackProps {
...
export class ICAv2CopyBatchStateMachineStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ICAv2CopyBatchStateMachineStackProps) {
    super(scope, id, props);

    // Generate icav2 copy batch stack
    const icav2_copy_batch_state_machine = new ICAv2CopyBatchStateMachineConstruct(
      this,
