...
class OrcaBusBaseManagerTestCase(TestCase):
    ...
    def test_reduce_multi_values_qor(self):
        """
        python manage.py test metadata_manager.tests.test_base.OrcaBusBaseManagerTestCase.test_reduce_multi_values_qor
        """
    ...
    def test_reduce_multi_values_qor_auto_pack(self):
        """
        python manage.py test metadata_manager.tests.test_base.OrcaBusBaseManagerTestCase.test_reduce_multi_values_qor_auto_pack
        """
    ...
    def test_base_model_must_abstract(self):
        """
        python manage.py test metadata_manager.tests.test_base.OrcaBusBaseManagerTestCase.test_base_model_must_abstract
        """
        try:
            OrcaBusBaseModel()
