...
from metadata_manager.models.metadata import Metadata, MetadataType, MetadataPhenotype
...
class MetadataFactory(factory.django.DjangoModelFactory):
    ...
    phenotype = MetadataPhenotype.NORMAL.value
    quality = "good"
    source = "blood"
    project_name = "CUP"
    project_owner = "UMCCR"
...
class TumorMetadataFactory(factory.django.DjangoModelFactory):
    ...
    subject_id = TestConstant.subject_id.value
    external_subject_id = "PM1234567"
    phenotype = MetadataPhenotype.TUMOR.value
    quality = "good"
    source = "blood"
    project_name = "CUP"
    project_owner = "UMCCR"
...
class WtsTumorMetadataFactory(factory.django.DjangoModelFactory):
    class Meta:
        model = Metadata
...
class WtsTumorMetadataFactory2(factory.django.DjangoModelFactory):
    class Meta:
        model = Metadata
