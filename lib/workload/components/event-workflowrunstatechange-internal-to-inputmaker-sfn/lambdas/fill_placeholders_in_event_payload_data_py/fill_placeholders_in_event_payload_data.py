...
def replace_values_recursively(data_dict: Dict, portal_run_id: str, workflow_name: str, workflow_version: str,
                               event_data_input: Dict):
    """
    ...
    for key, value in deepcopy(data_dict).items():
        if isinstance(value, dict):
            ...
            data_dict[key] = list(
                map(
                    lambda value_iter: replace_values_recursively(value_iter, portal_run_id, workflow_name,
                                                                  workflow_version, event_data_input),
            ...
            for input_key, input_value in event_data_input.items():
...
def handler(event, context):
    ...
    event_data_input: Dict = event.get('event_data_input', None)
    ...
    assert event_data_input is not None, 'Input event data is required'
    ...
    return {
        "event_data_updated": replace_values_recursively(event_data_output, portal_run_id, workflow_name,
                                                         workflow_version, event_data_input)
    }
...
#                         "sampleId": "L123456",
#                         "fastqListRows": ["foo", "bar"],
#                         "analysisOutputUri": "icav2://7595e8f2-32d3-4c76-a324-c6a85dae87b5/analysis_data/__workflow_name__/__workflow_version__/__portal_run_id__/",
#                         "icaLogsUri": "icav2://7595e8f2-32d3-4c76-a324-c6a85dae87b5/analysis_logs/__workflow_name__/__workflow_version__/__portal_run_id__/",
#                     }
#                 },
#                 None
#             ),
