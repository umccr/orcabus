...
const orcaBusStatefulStack = new OrcaBusStatefulStack(app, 'OrcaBusStatefulStack', {
  ...props,
  ...orcaBusStatefulConfig,
});

const orcaBusStatelessStack = new OrcaBusStatelessStack(app, 'OrcaBusStatelessStack', {
  ...props,
