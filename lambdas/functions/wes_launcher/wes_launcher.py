        ...
        "Records": [
            {
                ...
                "body": json.dumps(
                    create_wes_ens_body(workflow_name=workflow_name, status=status)
                ),
                "attributes": {
...
def create_wes_ens_body(workflow_name, status):
    return {
        ...
        "WorkflowRun": {
            ...
            "Acl": ["cid:123456789", "tid:123456789"],
            "WorkflowVersion": {
                "Id": "wfv.123456789",
                "TimeModified": "2021-04-30T14:38:21.777722Z",
                "Language": {"Name": "CWL"},
                "TenantId": "123456789",
                "Acl": ["tid:123456789", "cid:123456789", "wid:123456789"],
...
def handler(event, context):
    ...
    ens_event = create_sqs_event(
        workflow_name=wlr_event.workflow_run_name, status="Pending"
    )
