...
export const bsshFastqCopyManagerWorkflowType = 'bssh_fastq_copy';
export const bsshFastqCopyManagerWorkflowTypeVersion = '1.0.0';
export const bsshFastqCopyManagerServiceVersion = '2024.05.15';

export const bsshFastqCopyManagerReadyEventSource = 'orcabus.wfm';
export const bsshFastqCopyManagerEventSource = 'orcabus.bssh_fastq_copy_manager';
...
export const bclconvertInteropQcIcav2EventSource = 'orcabus.bclconvert_interop_qc';
