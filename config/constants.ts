...
export const bclconvertInteropQcIcav2PipelineManagerDynamodbTableName =
  'ctTSOv2ICAv2AnalysesDynamoDBTable';
...
// Stateless
export const bclconvertInteropQcIcav2PipelineSfnSSMName = path.join(
  bclConvertInteropQcSSMRoot,
  'state_machine_name'
);
export const bclconvertInteropQcIcav2PipelineSfnSSMArn = path.join(
  bclConvertInteropQcSSMRoot,
  'state_machine_arn'
);
...
export const bclconvertInteropQcIcav2PipelineIdSSMParameterPath =
  '/icav2/umccr-prod/bclconvert_interop_qc_pipeline_id'; // FIXME need to actually insert this path into SSM
