...
/*
Resources generated by the WGTS QC Stack
*/
...
export const wgtsQcIcav2ReferenceUriMappingSSMParameterPath =
  '/icav2/umccr-prod/wgts_qc_dragen_reference_mapping'; // '[{"name": "v9-r3", "uri": "icav2://92bc8608-9393-44b4-bf16-fb0c5a12269a/dragen-hash-tables/v9-r3/hg38-alt_masked-cnv-hla-rna/hg38-alt_masked.cnv.hla.rna-9-r3.0-1.tar.gz"}]'

export const wgtsQcIcav2AnnotationUriMappingSSMParameterPath =
  '/icav2/umccr-prod/wgts_qc_annotation_mapping'; // '[{"name": "v39", "uri": "icav2://92bc8608-9393-44b4-bf16-fb0c5a12269a/gencode/hg38/v39/gencode.v39.annotation.gtf"}]'
...
export const mockIcav2ProjectIdSsmParameterName = '/orcabus/stacky/icav2_project_id_and_name_json'; // {"project_id":"ea19a3f5-ec7c-4940-a474-c31cd91dbad4","project_name":"development"}
