...
*/
export const sequenceRunManagerEventDetailType = 'SequenceRunStateChange';
export const sequenceRunManagerEventSource = 'orcabus.sequencerunmanager';
...
// Deployed under dev/stg/prod
export const tnIcav2PipelineIdSSMParameterPath = '/icav2/umccr-prod/tumor_normal_4.2.4_pipeline_id'; // 8126b34a-393c-42b1-a38b-1640528cf6b9
...
// Deployed under dev/stg/prod
export const wtsIcav2PipelineIdSSMParameterPath = '/icav2/umccr-prod/wts_4.2.4_pipeline_id'; // 425cbb25-01bb-4dad-bf0a-87242cae71cb
